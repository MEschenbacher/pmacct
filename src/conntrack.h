...
void conntrack_ftp_helper(time_t, struct packet_ptrs *);
void conntrack_sip_helper(time_t, struct packet_ptrs *);
void conntrack_rtsp_helper(time_t, struct packet_ptrs *);
void search_conntrack(struct ip_flow_common *, struct packet_ptrs *, unsigned int);
void search_conntrack_ipv4(struct ip_flow_common *, struct packet_ptrs *, unsigned int);
void insert_conntrack_ipv4(time_t, u_int32_t, u_int32_t, u_int16_t, u_int16_t, u_int8_t, pm_class_t, conntrack_helper, time_t);
struct conntrack_ipv4 *conntrack_ipv4_table;
#if defined ENABLE_IPV6
void search_conntrack_ipv6(struct ip_flow_common *, struct packet_ptrs *, unsigned int);
void insert_conntrack_ipv6(time_t, struct in6_addr *, struct in6_addr *, u_int16_t, u_int16_t, u_int8_t, pm_class_t, conntrack_helper, time_t);
