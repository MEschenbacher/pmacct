...
#else
#endif
struct isis_route_info *isis_route_create (struct isis_prefix *, u_int32_t, u_int32_t, struct list *, struct isis_area *, int);
void isis_route_validate_table (struct isis_area *, struct route_table *);
void isis_route_validate_merge (struct isis_area *, int);
