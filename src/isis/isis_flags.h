...
#else
#endif
void flags_initialize (struct flags *);
struct flags *new_flags (int);
int flags_get_index (struct flags *);
void flags_free_index (struct flags *, int);
int flags_any_set (u_int32_t *);
