...
#define PRETAG_IN_IFACE			0x000000001ULL
#define PRETAG_OUT_IFACE		0x000000002ULL
#define PRETAG_NEXTHOP			0x000000004ULL
#define PRETAG_BGP_NEXTHOP		0x000000008ULL
...
#define PRETAG_SRC_AS			0x000000800ULL
#define PRETAG_DST_AS			0x000001000ULL
#define PRETAG_PEER_SRC_AS		0x000002000ULL
#define PRETAG_PEER_DST_AS		0x000004000ULL
#define PRETAG_SRC_LOCAL_PREF		0x000008000ULL
#define PRETAG_LOCAL_PREF		0x000010000ULL
#define PRETAG_SRC_STD_COMM		0x000020000ULL
#define PRETAG_STD_COMM			0x000040000ULL
#define PRETAG_MPLS_VPN_RD		0x000080000ULL
#define PRETAG_SAMPLE_TYPE      	0x000100000ULL
#define PRETAG_SET_TOS			0x000200000ULL
#define PRETAG_LOOKUP_BGP_PORT		0x000400000ULL
#define PRETAG_SET_TAG			0x000800000ULL
#define PRETAG_SET_TAG2			0x001000000ULL
#define PRETAG_MPLS_LABEL_BOTTOM	0x002000000ULL
#define PRETAG_FLOWSET_ID		0x004000000ULL
#define PRETAG_SRC_MAC			0x008000000ULL
#define PRETAG_DST_MAC			0x010000000ULL
#define PRETAG_VLAN_ID			0x020000000ULL
#define PRETAG_IP			0x040000000ULL
#define PRETAG_SET_LABEL		0x080000000ULL
#define PRETAG_CVLAN_ID			0x100000000ULL
#define PRETAG_MPLS_VPN_ID		0x200000000ULL
#define PRETAG_FWDSTATUS_ID		0x400000000ULL
