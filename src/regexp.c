...
pm_regexec(regexp *prog, char *string)
{
	...
	if (prog == NULL || string == NULL) {
		printf("<3>Regexp: NULL parameter\n");
		return(0);
	}
...
regmatch(char *prog)
{
	...
	while (scan != NULL) {
		...
		case END:
			...
			break;
		default:
			printf("<3>Regexp: memory corruption\n");
			return(0);
			break;
		}
	 ...
	 */
	printf("<3>Regexp: corrupted pointers\n");
	return(0);
}
...
regrepeat(char *p)
{
	...
	default:		/* Oh dear.  Called inappropriately. */
		printf("<3>Regexp: internal foulup\n");
...
#define BUFLEN 50
	...
	case PLUS:
		...
		break;
	default:
		printf("<3>Regexp: corrupted opcode\n");
		break;
	}
	if (p != NULL)
