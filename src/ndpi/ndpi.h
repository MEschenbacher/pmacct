...
void pm_ndpi_free_flow_info_half(struct pm_ndpi_flow_info *);

/* Process a packet and update the workflow  */
struct ndpi_proto pm_ndpi_workflow_process_packet(struct pm_ndpi_workflow *, struct packet_ptrs *);

/* compare two nodes in workflow */
int pm_ndpi_workflow_node_cmp(const void *, const void *);

struct pm_ndpi_flow_info *pm_ndpi_get_flow_info(struct pm_ndpi_workflow *, struct packet_ptrs *, u_int16_t, const struct ndpi_iphdr *,
...
struct pm_ndpi_flow_info *pm_ndpi_get_flow_info6(struct pm_ndpi_workflow *, struct packet_ptrs *, u_int16_t, const struct ndpi_ipv6hdr *,
        ...
        u_int16_t *, u_int8_t *);
struct ndpi_proto pm_ndpi_packet_processing(struct pm_ndpi_workflow *, struct packet_ptrs *, const u_int64_t, u_int16_t,
        const struct ndpi_iphdr *, struct ndpi_ipv6hdr *, u_int16_t, u_int16_t, u_int16_t);

u_int16_t pm_ndpi_node_guess_undetected_protocol(struct pm_ndpi_workflow *, struct pm_ndpi_flow_info *);
void pm_ndpi_idle_flows_cleanup(struct pm_ndpi_workflow *);

int pm_ndpi_node_idle_scan_walker(const void *, const pm_VISIT, const int, void *);
